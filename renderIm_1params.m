...
writetable(T,'/scratch/gk925/hpc_brdf_fitting50/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/hpc_brdf_fitting50');
...
imPath = ['/scratch/gk925/hpc_brdf_fitting50/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
